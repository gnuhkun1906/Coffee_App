...
export default function EditProduct() {
    ...
    const updateProduct=useLocation().state;
    ...
    useEffect(() => {
        setImageUrl(updateProduct.image)
    ...
    return (
        <div>
            ...
            <h1 className='my-4 fs-1'>  Chỉnh sửa sản phẩm</h1>
            <br />
            <br />
            ...
            <button className='btn btn-success fs-4' onClick={handleUpdate} >Update Product</button>
        </div>
    )
}
